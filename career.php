...
$conn = new mysqli($servername, $username, $password, $status);
...
if(isset($_POST['search']))
{
  ...
  $query = mysql_query("SELECT * FROM rasag WHERE job name LIKE '%$searchq%' OR category LIKE '%$searchq%'") or die("couldnt search");
  $count= mysql_num_rows($query);
  if($count==0)
  {
    $output = 'Theere was no serch results';
...
<html lang="en">
  ...
  <body>
            ...
            <h1 class="mb-2 text-black w-75"><span class="font-weight-bold"></span> </h1>
              ...
              <div class="tab-content bg-white p-4 rounded" id="pills-tabContent">
                      ...
                      <div class="col-md-6 col-lg-3 mb-3 mb-lg-0">
                        <div class="select-wrap">
                          ...
                          <select name="" id="" class="form-control">
                            ...
                            <option value="fulltime">Banglore</option>
                            <option value="fulltime">Hyderabad</option>
                ...
                <div class="tab-pane fade" id="pills-candidate" role="tabpanel" aria-labelledby="pills-candidate-tab">
                  <form action="#" method="post">
                    <div class="row">
                      <div class="col-md-6 col-lg-3 mb-3 mb-lg-0">
                        <input type="text" class="form-control" placeholder="eg. Shreya Rajput">
                      </div>
                      <div class="col-md-6 col-lg-3 mb-3 mb-lg-0">
                        <div class="select-wrap">
                          <span class="icon-keyboard_arrow_down arrow-down"></span>
